...
ifeq ($(PLATFORM),PLATFORM_RPI)
    ifeq ($(USE_RPI_CROSS_COMPILER),TRUE)
        ...
        #CC = armv6j-hardfloat-linux-gnueabi-gpp
        CC = $(RPI_TOOLCHAIN)/bin/arm-linux-gnueabihf-gpp
    endif
endif
ifeq ($(PLATFORM),PLATFORM_WEB)
...
#  -Wno-missing-braces  ignore invalid warning (gpp bug 53119)
